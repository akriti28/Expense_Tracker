...
public class Home extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        final EditText e= (EditText) findViewById(R.id.inc);
        final TextView t=(TextView) findViewById(R.id.bal);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int balance = Integer.parseInt(t.getText().toString());
                int income = Integer.parseInt(e.getText().toString());
                int c = balance + income;
